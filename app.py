...
# --- 1. إعدادات Gemini ---
GEMINI_API_KEY = "AIzaSyA09CRrRdWebhSPg9sEKT2gRupNWx2tI2g" 
...
def get_or_create_phone_id(phone_name):
    ...
    if phone_id: 
        print(f"Found locally: {phone_id}")
        return phone_id
        
    print(f"Phone '{phone_name}' not in DB. Trying scraper...")
    
    # 2. البحث أونلاين إذا لم يكن موجوداً
    ...
    # إضافة الهاتف وإرجاع الـ ID الجديد
